...
data1-dataN - данные, которые нужно вывести на экран<br>
sep - разделитель, который ставится между аргументами (по умолчанию равен пробелу - ' '). Необязательный параметр<br>
end - определяет, что нужно поставить в конце вывода (по умолчанию равен символу перевода строки - '\n' ). Необязательный параметр

<code>print()</code> - выводит на экран пустую строку
...
s = 'строка'<br>
n = 12<br>
name = input('Введи своё имя: ')<br>
name, surname = input('Введи своё имя: '), input('Введи свою фамилию: ')
