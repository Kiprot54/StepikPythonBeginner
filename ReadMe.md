...
| <!-- -->                                                             | <!-- -->                                                                       | <!-- -->                                                                                                     |
|----------------------------------------------------------------------|--------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------|
| [**7.4.1.** Till END](problems/problem7.4.1.Till_END.md)             | [**7.4.2.** Number of members](problems/problem7.4.2.Number_of_members.md)     | [**7.4.3.** While_sharing](problems/problem7.4.3.While_sharing.md)                                           |
...
| <!-- -->                                                               | <!-- -->                                                               | <!-- -->                                                       |
|------------------------------------------------------------------------|------------------------------------------------------------------------|----------------------------------------------------------------|
| [**7.5.1.** Reverse order 1](problems/problem7.5.1.Reverse_order_1.md) | [**7.5.2.** Reverse order 2](problems/problem7.5.2.Reverse_order_2.md) | [**7.5.3.** max and min](problems/problem7.5.3.max_and_min.md) |
...
| <!-- -->                                                           | <!-- -->                                                                 |
|--------------------------------------------------------------------|--------------------------------------------------------------------------|
| [**7.6.1.** Least divisor](problems/problem7.6.1.Least_divisor.md) | [**7.6.2.** Follow the rules](problems/problem7.6.2.Follow_the_rules.md) |
...
| [**9.1.4.** In column 2](problems/problem9.1.4.In_column_2.md)                       | [**9.1.5.** Full name](problems/problem9.1.5.Full_name.md)                     | [**9.1.6.** Number 1](problems/problem9.1.6.Number_1.md)                       |
...
| <!-- -->                                                                               | <!-- -->                                                                                                   | <!-- -->                                                                           |
|----------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------|
| [**11.2.1.** 17th list item](problems/problem11.2.1.17th_list_item.md)                 | [**11.2.2.** Last list item](problems/problem11.2.2.Last_list_item.md)                                     | [**11.2.3.** First six list items](problems/problem11.2.3.First_six_list_items.md) |
...
| <!-- -->                                                             | <!-- -->                                                   | <!-- -->                                                             |
|----------------------------------------------------------------------|------------------------------------------------------------|----------------------------------------------------------------------|
| [**13.2.1.** Star Triangle](problems/problem13.2.1.Star_Triangle.md) | [**13.2.2.** Initials](problems/problem13.2.2.Initials.md) | [**13.2.3.** Sum of digits](problems/problem13.2.3.Sum_of_digits.md) |
...
| <!-- -->                                                                 | <!-- -->                                                                                 | <!-- -->                                                               |
|--------------------------------------------------------------------------|------------------------------------------------------------------------------------------|------------------------------------------------------------------------|
| [**13.4.1.** Find hypotenuse](problems/problem13.4.1.Find_hypotenuse.md) | [**13.4.2.** Distance between points](problems/problem13.4.2.Distance_between_points.md) | [**13.4.3.** Sum of digits](problems/problem13.4.3.Sum_of_digits.md)   |
...
| <!-- -->                                               | <!-- -->                                               | <!-- -->                                                     |
|--------------------------------------------------------|--------------------------------------------------------|--------------------------------------------------------------|
| [**15.1.1.** Dice 1](problems/problem15.1.1.Dice_1.md) | [**15.1.2.** Dice 2](problems/problem15.1.2.Dice_2.md) | [**15.1.3.** Coin flip](problems/problem15.1.3.Coin_flip.md) |

### 15.2. *Числовая угадайка*

| <!-- -->                                                                              | <!-- -->                                                                       |
|---------------------------------------------------------------------------------------|--------------------------------------------------------------------------------|
| [**15.2.1.** Timur and his numbers*](problems/problem15.2.1.Timur_and_his_numbers.md) | [**15.2.2.** Numerical guessing](problems/problem15.2.2.Numerical_guessing.md) |

### 15.3. *Магический шар 8*

| <!-- -->                                                           |
|--------------------------------------------------------------------|
| [**15.3.1.** Magic 8 ball](problems/problem15.3.1.Magic_8_ball.md) |

### 15.4. *Генератор безопасных паролей*

| <!-- -->                                                                                     |
|----------------------------------------------------------------------------------------------|
| [**15.4.1.** Secure password generator](problems/problem15.4.1.Secure_password_generator.md) |

### 15.5. *Шифр Цезаря*

| <!-- -->                                                                 | <!-- -->                                                         |
|--------------------------------------------------------------------------|------------------------------------------------------------------|
| [**15.5.1.** Caesar's cipher*](problems/problem15.5.1.Caesars_cipher.md) | [**15.5.2.** Ave, Caesar*](problems/problem15.5.2.Ave_Caesar.md) |
...
| <!-- -->                                         |
|--------------------------------------------------|
| [**15.6.1.** BOH](problems/problem15.6.1.BOH.md) |

### 15.7. *Угадайка слов*

| <!-- -->                                                         |
|------------------------------------------------------------------|
| [**15.7.1.** Guess words](problems/problem15.7.1.Guess_words.md) |

## Задачи с turtle

| <!-- -->                                       | <!-- -->                                                        | <!-- -->                                              |
|------------------------------------------------|-----------------------------------------------------------------|-------------------------------------------------------|
| [**t1.** Rectangle](problems/t1.Rectangle.md) | [**t2.** Right triangle](problems/t1.Rectangle.md) | [**t3.** Three squares](problems/t3.Three_squares.md) |
